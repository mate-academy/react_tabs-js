...
1. Pass the `onTabSelected` callback to the `Tabs`, it should be called whenever the user selects another tab.1ю Зфыы еру щтЕфиЫудусеув сфддифсл ещ еру Ефиыб ше ырщгдв иу сфддув црутумук еру гыук ыудусеы фтщерук ефию
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://ant-tur.github.io/react_tabs-js/) and add it to the PR description.
